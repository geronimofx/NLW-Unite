  ...
  return (
    <div className='flex flex-col gap-4'>
      <div className="flex  gap-3 items-center">
        ...
        <div className="flex items-center px-3 py-1.5 border gap-3 border-white/10 rounded-lg w-72">
        ...
        <table className='w-full border'>
            ...
            {Array.from({ length: 10 }).map((_, i) => {
              return (
                <tr key={i} className='border-b border-white/10 hover:bg-white/5'>
                  ...
                  <td className='py-3 px-4 text-sm text-zinc-300'>3145135</td>
                  <td className='py-3 px-4 text-sm text-zinc-300'>
                    <div className='flex flex-col gap-1'>
                      <span className='font-semibold text-white'>Rafael Geronimo</span>
          ...
          <tfoot>
            <tr>
              ...
              <td colSpan={3} className='flexpy-3 px-4 text-sm text-zinc-300 text-right'>
